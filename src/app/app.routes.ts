...
export const routes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'analyze-url',
                loadComponent: () => import('./pages/dashboard/views/analyze-url/analyze-url').then(m => m.AnalyzeUrl),
            },
            {
                path: 'history',
                loadComponent: () => import('./pages/dashboard/views/history/history').then(m => m.History),
            }
        ]
    }
