...
const initialState: AnalyzeStore = {
  ...
  generations: [
    { label: 'Title', enabled: true, value: 'title' },
    { label: 'Description', enabled: true, value: 'description' },
    { label: 'Tags', enabled: true, value: 'tags' },
    { label: 'Thumbnail', enabled: true, value: 'thumbnail' },
    { label: 'SEO Keywords', enabled: true, value: 'keywords' },
  ],
